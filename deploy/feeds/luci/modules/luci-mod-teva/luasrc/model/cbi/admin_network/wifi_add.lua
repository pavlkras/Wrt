...
m.hidden = {
	...
	password = http.formvalue("password")   --[[ передача пароля с страницы выбора wi-fi]]--
}
...
newnet.parse(self,1);	   -- вызов функии, которая собирает настройки и начинает процесс подключения
