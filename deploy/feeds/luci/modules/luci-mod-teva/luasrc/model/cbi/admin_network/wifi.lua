...
function parseConnectAndApply(self, readinput, ...)
...
function m.parse(map)
	...
	parseConnectAndApply(map)





             luci.sys.call("env -i /sbin/ifup %q 2>&1 >/dev/null" % iface)
                      		luci.http.redirect("http://192.168.1.1/joined.htm")
end
